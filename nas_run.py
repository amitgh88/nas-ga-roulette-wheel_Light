...
# Use fewer samples for faster NAS during testing / logging
train_subset = Subset(trainset, range(1000))   # was 5000
val_subset   = Subset(valset, range(500))      # was 1000

train_loader = DataLoader(train_subset, batch_size=128, shuffle=True)
val_loader   = DataLoader(val_subset, batch_size=128, shuffle=False)

ga = GeneticAlgorithm(
    population_size=6,   # was 10
    generations=3,       # was 5
    mutation_rate=0.3,
    crossover_rate=0.7
)
